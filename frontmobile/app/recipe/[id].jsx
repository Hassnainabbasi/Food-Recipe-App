...
import { HOST_URL } from "../../constants/constant";
import { BASE_URL, Fav_URL, MealApi, WEB_URL } from '../../services/mealAPI.js'
            ...
            <View style={recipeDetailStyles.instructionsContainer}>
              {recipe?.instructions?.map((step, idx) => (
                <View key={idx} style={recipeDetailStyles.instructionCard}>
                  ...
                  >
                    <Text style={recipeDetailStyles.stepNumber}>{idx + 1}</Text>
                  </LinearGradient>
                  <View style={recipeDetailStyles.instructionContent}>
                    ...
                    <View style={recipeDetailStyles.instructionFooter}>
                      <Text style={recipeDetailStyles.stepLabel}>Step {idx + 1}</Text>
